...
from marker import marker as maker
...
def main(Impact_frame):
    ...
    marker_master_front(point, mov_x, mov_y, side_x, side_y)
    marker_master_side(point, mov_x, mov_y, side_x, side_y)
    maker(point, mov_x, mov_y, side_x, side_y, mark, side_mark)
    #marker_head(point, mov_x, mov_y, side_x, side_y)
    #marker_wrist(point, mov_x, mov_y, side_x, side_y)
    #marker_Knee(point, mov_x, mov_y, side_x, side_y)
    #marker_pelvis(point, mov_x, mov_y, side_x, side_y)
    #maker(point, mov_x, mov_y, side_x, side_y, mark, side_mark)
